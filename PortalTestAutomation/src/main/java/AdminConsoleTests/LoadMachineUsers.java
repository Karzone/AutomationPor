 ...
 * Copyrights : KCOM
 */
public class LoadMachineUsers extends ModuleBase{
// region Declarations
...
// endregion
     ...
     */
    @Test
    public void LoadMachineUsersTest() throws Exception{
        try {
    ...
    public static void CreateMachineUser() throws Exception
    {
        try{
            ...
            logger.log ( LogStatus.PASS, "The Machine User [" + machineUserName + "] Created Successfully : " );
